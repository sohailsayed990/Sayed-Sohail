class bank:
    ...
    def deposit(self,acc_no=None,acc_type=None,cash_amount=None,cheque_no=None,
...
b1=bank()
b1.deposit(acc_no=11223344556677,acc_type='saving',cash_amount=2000000)
b1.deposit(acc_no=11223344556677,acc_type='saving',cheque_no='CH1122',cheque_amount=4000000)
b1.deposit(acc_no=11223344556677,acc_type='saving',dd_no='DD1122',dd_amount=5000000)
b1.deposit(acc_no=11223344556677,acc_type='saving'
           )
